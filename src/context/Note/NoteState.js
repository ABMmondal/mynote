...
const getAllNotes = async ()=>{
  const Response =await fetch(`${host}/api/auth/fetchNotes`,{
    ...
    headers:{
      ...
      'auth-token':'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjp7ImlkIjoiNjVhODM2M2Q4YTlkZjJiZDdhYmU5MWM3In0sImlhdCI6MTcwNTU4Nzg4NH0.0p9aQsSe8acN7q7UbLOOMjLwXfiezIPpFLrPRGF_a_I'
      },
